<#
    .SYNOPSIS
        This is the alias to the build task Generate_External_Help_File_For_Public_Commands's script file.
...
Set-Alias -Name 'Task.Generate_External_Help_File_For_Public_Commands.build' -Value "$PSScriptRoot/tasks/Generate_External_Help_File_For_Public_Commands.build.ps1"
