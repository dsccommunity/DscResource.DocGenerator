...
Describe 'Clean_Markdown_Metadata' {
    BeforeAll {
        ...
        Mock -CommandName Remove-MarkdownMetadataBlock
    ...
    It 'Should export the build script alias' {
        $buildTaskName = 'Clean_Markdown_Metadata'
...
5
    It 'Should run the build task without throwing' {
        ...
        Assert-MockCalled -CommandName Remove-MarkdownMetadataBlock -Exactly -Times 1 -Scope 'It'
    }
}
