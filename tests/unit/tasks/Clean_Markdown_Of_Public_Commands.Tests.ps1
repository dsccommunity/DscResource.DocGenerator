...
Describe 'Clean_Markdown_Of_Public_Commands' {
    BeforeAll {
        ...
        Mock -CommandName Edit-CommandDocumentation
    ...
    It 'Should export the build script alias' {
        $buildTaskName = 'Clean_Markdown_Of_Public_Commands'
...
5
    It 'Should run the build task without throwing' {
        ...
        Assert-MockCalled -CommandName Edit-CommandDocumentation -Exactly -Times 1 -Scope 'It'
    }
}
