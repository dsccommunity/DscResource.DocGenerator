...
InModuleScope $script:moduleName {
    ...
    Describe 'New-DscMofResourceWikiPage' {
...
' -replace '\r?\n', "`r`n"
            ...
            Context 'When there are no schemas found in the module folder' {
                ...
                It 'Should not throw an exception' {
                    { New-DscMofResourceWikiPage @script:newDscResourceWikiPageOutput_parameters } | Should -Not -Throw
                }
...
' -replace '\r?\n', "`r`n"
                ...
                It 'Should not throw an exception' {
                    {
                        New-DscMofResourceWikiPage @script:newDscResourceWikiPageOutput_parameters -Metadata @{
                            Type = 'MofResource'
                            Module = 'MyClassModule'
                        }
                    } | Should -Not -Throw
